...
const ProductCard = ({ name, image, price, description, delay = 0 }: ProductCardProps) => {
  const whatsappUrl = `https://wa.me/923001234567?text=Hi!%20I%20would%20like%20to%20order%20${encodeURIComponent(name)}.`;
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col">
        <h3 className="font-montserrat text-lg font-semibold text-foreground">{name}</h3>
        ...
        <p className="text-primary font-bold text-lg mt-2">{price}</p>
